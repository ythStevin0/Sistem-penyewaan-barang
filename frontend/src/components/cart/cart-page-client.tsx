  ...
  if (cartItems.length === 0) {
    return (
      <div className="container py-16 max-w-2xl text-center">
        ...
        <h1 className="text-2xl font-extrabold text-foreground mb-2">Keranjang Kosong</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <div className="sticky top-24 space-y-4">
            <div className="bg-card rounded-xl border border-border p-5 shadow-sm">
              ...
              {datesReady && (
                <p className="text-sm text-muted-foreground mt-3">
                  Durasi sewa: <span className="font-bold text-foreground">{totalDays} hari</span>
                </p>
              )}
              {!datesReady && (
                <p className="text-sm alert-warning rounded-lg px-3 py-2 mt-3">
            ...
            <div className="bg-card rounded-xl border border-border p-5 shadow-sm">
              <h2 className="font-bold text-foreground mb-4">Ringkasan Biaya</h2>
